...
/*
- Outils d'analyse de code (phpunit, pest, etc.):
    - PHP_CodeSniffer: ./vendor/bin/phpcs - The file .phpcs.xml is already created
    - PHPUnit: ./vendor/bin/phpunit
    - Psalm: ./vendor/bin/psalm
    - ESLint: ./node_modules/eslint/bin/eslint.js --ext .js,.vue resources/js/
    Pas exécuté automatiquement pour le moment lors des MR:
        PHPStan (Larastan): ./vendor/bin/phpstan analyse --xdebug
